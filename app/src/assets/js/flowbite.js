/******/ (() => {
    ...
    /******/ var __webpack_modules__ = {
        /***/ 366: /***/ () => {
            var hideAllOtherAccordionHeaderElements =
                function hideAllOtherAccordionHeaderElements(
                    accordionHeaderElements,
                    currentAccordionHeaderEl,
                    activeClassesArray,
                    inactiveClassesArray
                ) {
                    accordionHeaderElements.forEach(function (headerEl) {
                        if (currentAccordionHeaderEl !== headerEl) {
                            var bodyEl = document.querySelector(
                                headerEl.getAttribute("data-accordion-target")
                            );
                            ...
                            if (
                                headerEl.querySelector("[data-accordion-icon]")
                            ) {
                                headerEl
            ...
            var rotateAccordionIcon = function rotateAccordionIcon(
                accordionHeaderEl
            ) {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                document
                    ...
                    .forEach(function (accordionEl) {
                        ...
                        var collapseAccordion =
                            accordionEl.getAttribute("data-accordion");
                        var accordionHeaderElements = document.querySelectorAll(
                            "#" + accordionId + " [data-accordion-target]"
                        );
                        ...
                        accordionHeaderElements.forEach(function (
                            accordionHeaderEl
                        ) {
                            var accordionBodyEl = document.querySelector(
                                accordionHeaderEl.getAttribute(
                                    "data-accordion-target"
                                )
                            );
                            accordionHeaderEl.addEventListener(
                                "click",
                                function () {
                                    if (collapseAccordion === "collapse") {
                                        hideAllOtherAccordionHeaderElements(
                                            accordionHeaderElements,
                                            accordionHeaderEl,
                                            activeClassesArray,
                                            inactiveClassesArray
                                    ...
                                    if (
                                        ...
                                        accordionHeaderEl.setAttribute(
                                            "aria-expanded",
                                            false
                                        ); // active classes

                                        activeClassesArray.map(function (c) {
                                            accordionHeaderEl.classList.remove(
                                                c
                                            );
                                        }); // inactive classes
                                        ...
                                        accordionBodyEl.classList.remove(
                                            "hidden"
                                        );
                                        rotateAccordionIcon(accordionHeaderEl);
                                    }
        ...
        /***/ 791: /***/ () => {
                ...
                document
                    ...
                    .forEach(function (carouselEl) {
                        ...
                        carouselEl
                            ...
                            .forEach(function (slideToEl) {
                                slideToEl.addEventListener(
                                    "click",
                                    function () {
                                        var id = slideToEl.getAttribute(
            ...
            var Carousel = /*#__PURE__*/ (function () {
                function Carousel(id, options) {
                    ...
                    this._items = _toConsumableArray(
                        this._el.querySelectorAll("[data-carousel-item]")
                    ).length
                        ? _toConsumableArray(
                              this._el.querySelectorAll("[data-carousel-item]")
                          ).map(function (el, id) {
                        ...
                        : [];
                    this._indicators = _toConsumableArray(
                        this._el.querySelectorAll("[data-carousel-slide-to]")
                    ).length
                        ? _toConsumableArray(
                        ...
                        : [];
                    this._interval = null;
                    this._intervalDuration = options.interval
                        ? options.interval
                        : Default.interval;
                            ...
                            var rotationItems = {
                                left:
                                    nextItem.id === 0
                                        ...
                                        : this._items[nextItem.id - 1],
                                middle: nextItem,
                                right:
                                    nextItem.id === this._items.length - 1
                                        ? this._items[0]
                                        : this._items[nextItem.id + 1],
                            };
            ...
            document.addEventListener("DOMContentLoaded", function () {
                document
                    ...
                    .forEach(function (modalToggleEl) {
                        var modalId =
                            modalToggleEl.getAttribute("data-modal-toggle");
                        var modalEl = document.getElementById(modalId);
            ...
            document.addEventListener("DOMContentLoaded", function () {
                document
                    ...
                    .forEach(function (tabsToggleEl) {
                        var tabsToggleElementsId =
                            tabsToggleEl.getAttribute("id");
                        var tabsToggleElements = document.querySelectorAll(
                        ...
                        tabsToggleElements.forEach(function (tabToggleEl) {
                            tabToggleEl.addEventListener(
                                "click",
                                function (event) {
                                    var tabToggleEl = event.target;
                                    var tabTargetSelector =
                                        tabToggleEl.getAttribute(
                                            "data-tabs-target"
                                        );
                                    var tabContentEl =
                                    ...
                                    if (tabToggleEl !== activeTabToggleEl) {
                                        ...
                                        if (
                                            ...
                                            activeTabToggleEl =
                                                document.querySelector(
                                                    "#" +
                                                        tabsToggleElementsId +
                                                        ' [aria-selected="true"]'
                                                );
                                            activeTabContentEl =
                                                document.querySelector(
                                                    activeTabToggleEl.getAttribute(
                                                        "data-tabs-target"
                                                    )
                                                );
                                        ...
                                        tabToggleEl.setAttribute(
                                            "aria-selected",
                                            true
                                        );
                                        tabContentEl.classList.remove("hidden"); // hide and deactive currently active tab toggle and content

                                        activeTabToggleEl.setAttribute(
                                            "aria-selected",
                                            false
                                        );
                                        activeTabToggleEl.classList.remove(
                                            "active"
                                        );
                                        activeTabContentEl.classList.add(
                                            "hidden"
    ...
    (() => {
        ...
        var carousel = __webpack_require__(791); // CONCATENATED MODULE: ./node_modules/@popperjs/core/lib/dom-utils/getWindow.js
      ...
      */
                ...
                function runModifierEffects() {
                    state.orderedModifiers.forEach(function (_ref3) {
                        var name = _ref3.name,
                            ...
                            options =
                                _ref3$options === void 0 ? {} : _ref3$options,
                            effect = _ref3.effect;
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document
                ...
                .forEach(function (dropdownToggleEl) {
                    var dropdownMenuId = dropdownToggleEl.getAttribute(
                        "data-dropdown-toggle"
                    );
                    var dropdownMenuEl =
                        document.getElementById(dropdownMenuId); // options

                    var placement = dropdownToggleEl.getAttribute(
        ...
        var modal = __webpack_require__(84); // CONCATENATED MODULE: ./src/components/tooltip.js
        function _toConsumableArray(arr) {
            return (
                _arrayWithoutHoles(arr) ||
                _iterableToArray(arr) ||
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document
                ...
                .forEach(function (tooltipToggleEl) {
                    ...
                    var placement = tooltipToggleEl.getAttribute(
                        "data-tooltip-placement"
                    );
                    var trigger = tooltipToggleEl.getAttribute(
                        "data-tooltip-trigger"
                    );
                    var popperInstance = popper_createPopper(
                        tooltipToggleEl,
                        tooltipEl,
                        {
                    ...
                    function show() {
                        ...
                        popperInstance.setOptions(function (options) {
                            return _objectSpread(
                                ...
                                {
                                    modifiers: [].concat(
                                        _toConsumableArray(options.modifiers),
                                        [
                                            {
                                                name: "eventListeners",
                                                enabled: true,
